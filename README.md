...
2. Clone the project and enter the project directory
   ```shell
   git clone https://github.com/devman-AI/wechat-chatgpt.git && cd wechat-chatgpt
   ```
3. Create a new app
   ```shell
   ➜ flyctl launch 
...
<a href="https://github.com/devman-AI/wechat-chatgpt/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=devman-AI/wechat-chatgpt" />
</a>

## 🤝 Contributing

Contributions, issues and feature requests are welcome!<br />Feel free to
check [issues page](https://github.com/devman-AI/wechat-chatgpt/issues).
